    ...
    xhttp.onreadystatechange = function() {
        ...
        if (xhttp.readyState === 4) {
            ...
            for (var i = 0; i < response.length; i++) {
                ...
                table += '<tr class="data-row" id="' + response[i].id + '"> <td class="column1">' + response[i].id + '</td><td class="column2">' + response[i].firstName + '</td><td class="column3">' + response[i].lastName + '</td><td class="column">' + response[i].email + '</td><td class="column5">' + response[i].phone + '</td></tr>';
